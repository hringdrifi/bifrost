...
| アルミ製丸型両雌ねじスペーサー | M2 × 5 mm | 8 本 | [ヒロスギ](https://hirosugi.co.jp/)（[Web ショップ](https://www.hirosugi-net.co.jp/)） | `ARL-2005E` |
...
> アルミ製プレートに真鍮製のねじを直接接触させ、水分や塩分が介在すると、異種金属接触によってアルミ側の腐食が促進される場合があります。通常の乾燥した室内環境では大きな問題になりませんが、耐食性を優先する場合はステンレス製の締結部品を使用してください。
