...
- Plate PCB: bifrost_plate.kicad_pcb contains center-origin key-hole footprints for the same physical layout.
- Switch footprint: Smidr:SW_Smidr_Gateron_LP_Hotswap
...
- Backlight: per-key backlight LEDs are placed with switch-specific LED offsets (Smidr:LED_Smidr_Backlight_1206_Reverse).
